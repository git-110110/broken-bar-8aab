...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/broken-bar-8aab
```

A live public deployment of this template is available at [https://broken-bar-8aab.templates.workers.dev](https://broken-bar-8aab.templates.workers.dev)
